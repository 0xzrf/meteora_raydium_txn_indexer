use crate::{
    ...
    parser::{Actions, CopyReturnType, CopyTradeParseData, token_transfer::TokenTxnInfo},
};
pub struct RaydiumAmmCopyProgram {
...
impl RaydiumAmmCopyProgram {
    ...
    pub fn add_liquidity(self, owner: String) -> CopyReturnType {
    ...
    pub fn remove_liquidity(self, owner: String) -> CopyReturnType {
        let keys = &self.account_keys;
